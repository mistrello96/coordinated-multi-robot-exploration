...
\begin{appendices}
	...
	\label{apx:alpha}
	\input{Appendix_alpha}
	\chapter{Ulteriori risultati ottenuti dall'analisi del parametro $\gamma$}
	\label{apx:gamma}
	\input{Appendix_gamma}
	\chapter{Stati dei robot durante l'esplorazione}
	\label{apx:status}
	\input{Appendix_status}
	\chapter{Visualizzazione dell'interfaccia del simulatore e delle mappe utilizzate per i test}
	\label{apx:screen}
	\input{Appendix_screen}
\end{appendices}
